...
session_start();
?>
<div ID="Chat" style="display: none" style="overflow-y: hidden;overflow-x: hidden ;" >
...
text/plain,application/vnd.openxmlformats-officedocument.presentationml.presentation" name="CreateChatRequestFile" value="set" class="right adjustText"  >
        </form>
    </div>
    </div>

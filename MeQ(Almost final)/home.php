...
<div class="content">
    ...
    <div class="rightSide" style="background-color: #f5f5f5">
        <iframe width="80%"  style="border: 0px solid black; display: none; height: 1024px;"id="HomeFrame" src="view/HomeView.php"></iframe>
        <iframe width="80%"  style="border: 0px solid black;"id="Frame" src="view/threads.xml"></iframe>
        <iframe width="80%"  style="border: 0px solid black; display: none;"id="Frame2" src="view/exercises.xml"></iframe>
        <div id="rightBanner" style=" position:sticky ;float : right; background-color:#f5f5f5;" >
            <div id="Activity log" style="display: block">
                ...
                <div class="AdminConsole" style="display:none;">
                    ...
                    <iframe style="border-radius: 10px; border: 0px solid black; height: 300px; width: 100%;" src="controller/admin_controller.php">

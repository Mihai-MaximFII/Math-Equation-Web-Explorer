...
if(isset($_SESSION['IsAdmin']))
{
    ...
    echo '
    <form method="post">
    <input name="AddAdminText" type="text" style="width: 60%;">
    <button name="AddAdmin">Add Admin</button>';
    echo '<br><br>';
    if($_SESSION['Username']=='mihaimaxim')
        echo '
        <input name="RemoveAdminText" type="text" style="width:60%;">
        <button name="RemoveAdmin">Remove Admin</button>
        <br><br>
        ';
    echo '<input name="BlockUserText" type="text" style="width: 60%;">
         <button name="BlockUser">Block User</button>
         ';
    echo '<br><br>';

    echo '<input name="UnblockUserText" type="text" style="width: 60%;">
         <button name="UnblockUser">Unblock User</button>
         ';
    echo '<br><br>';
    echo '<input name="DeleteChatMessagesText" type="text" style="width: 60%;">
         <button name="DeleteChatMessages">Delete Chat Messages</button>
         ';
    echo '
    </form>
    ';
